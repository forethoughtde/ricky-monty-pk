            ...
            </Helmet>
            {
                characters.map((character)=>{
                    return (<div className="character-item" key={character.id}>
                        ...
                        <p style={textAlignCenterStyle} className="character-detail">
                            <strong>Name:</strong> {character.name}</p>
                        <p style={textAlignCenterStyle} className="character-detail">
                            <strong>Status:</strong> {character.status}</p>
                        <p style={textAlignCenterStyle} className="character-detail">
                            <strong>Species:</strong> {character.species}</p>
                        <p style={textAlignCenterStyle} className="character-detail">
